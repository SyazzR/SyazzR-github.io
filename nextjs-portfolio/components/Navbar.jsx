    ...
    return (
        <div 
            ...
            <div className='flex justify-between items-center w-full h-full pb-2 2xl:px-16'>
                ...
                <div>
                    <ul style={{color: `${linkColor}`}} className='hidden md:flex md:mr-2'>
                        <Link href="/">
                    ...
                    <div onClick={handleNav} className='mr-2 md:hidden'>
                ...
                <div className={nav ? 'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500 '
                    ...
                    <div>
                        <div className='flex w-full items-center justify-between'>
                            <Image src="/../public/assets/navLogo.png" alt="" width="90" height="25" />
